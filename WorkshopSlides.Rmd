...
```{r}
g2 %>% 
  # add_edges(c("historicData", "lifeExpPlot",
  #                  "year", "lifeExpPlot")) %>% 
  plot(layout = layout2)
```
...
- Use the option `theme = shinytheme("themename")` on your user interface function (`fluidPage`) in our example [git:13_changetheme]()
...
- The widths of each row of columns should sum to 12 [git:14_fluidpage]()
