...
date: "RSE 2018 Conference<p><a href='https://uomresearchit.github.io/RSE18-shiny-workshop/'>https://uomresearchit.github.io/RSE18-shiny-workshop/</a></p><p><img src='http://assets.manchester.ac.uk/logos/hi-res/TAB_UNI_MAIN_logo/White_backgrounds/TAB_col_white_background.png' style='border:0px solid black' width='25%'></p>"
output: 
...
```
rm -rf mawdsley
git clone https://github.com/UoMResearchIT/
  RSE18-shiny-workshop-materials.git mawdsley
cd mawdsley
...
- To use Shiny to make an interactive plot
    ...
    - (Show the richest country on the gaph and its GDP)
...
* Copy the gapminder data and `workshopFunctions.R` to the app directory
...
- The widths of each row of columns should sum to 12 [git:14_layout]()
