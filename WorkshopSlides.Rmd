...
* Check this works
* Modify the app to load the tidyverse library, gapminder data and `plottingFunctions.R` <span style="color:red">loadresources</span>
...
- Modify `output$mainPlot` to highlight the selected country and show a trace of its trajectory.
    - `codeExample.R` contains an example of doing this.
    
## Stretch exercises

- add another tab and put a second plot in it, showing gdp vs fertility rate 
- add tree selector to select countries by continent
