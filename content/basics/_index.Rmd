...
Choose a suitable name for the directory (e.g. "gapminder").   For "Creat project a subdirectory of:" we suggest using `c:\work`.  At the end of the course, you can copy your project directory to your P drive.  [git:01_defaultapp]()
